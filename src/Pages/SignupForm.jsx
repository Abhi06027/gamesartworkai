...
const SignupForm = () => {
  return (
    <div className="bg-white flex h-screen md:justify-center md:items-center">
      <div className=" bg-white md:shadow-md lg:border mx-auto rounded-lg md:px-8 py-8">
        <h2 className="font-bold text-black text-center text-[24px]">GAG</h2>
        <p className="text-lg py-2 font-medium text-center">
          Sign in to your account
        </p>
        <div className="mx-auto container">
          <div>
            <InputField
              style="w-full h-[55px] my-1 pl-5 font-medium text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              name="email"
              type="email"
